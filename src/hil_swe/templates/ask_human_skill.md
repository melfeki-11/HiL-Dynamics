...
description: |-
    Ask a focused clarification question when a coding task has missing, ambiguous, or contradictory requirements that are not explicitly answered by the prompt or codebase.
---
